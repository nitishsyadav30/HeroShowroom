...
class CustomersController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Customers'])) {
            ...
            if ($model->validate()) {
                if (mkdir(Yii::getPathOfAlias('webroot') . "/customer_docs/" . $model->c_mobile)) {
                    $model->file->saveAs(Yii::getPathOfAlias('webroot') . '/customer_docs/'.$model->c_mobile.'/' . $model->file);
                }
            }
            $model->c_file_path = Yii::app()->request->baseUrl . '/customer_docs/'.$model->c_mobile.'/' . $model->file;
            if ($model->save())
...
//    }
    ...
    protected function StrToTime($year, $month, $day) {
        $date = $year . '-' . $month . '-' . $day;
